...
public:
    ...
    */
    ...
    /**
     * @brief Метод порождающий BRN по строковому представлению числа.
     * @param[in] numb строковое представление числа.
     * @return Объект BRN.
     * 
     * @exception ActionBuildError если невозможно создать объект под данной строке
    */
...
private:
    ...
    */
     ...
     * 32.2 >> 1 --> 3.22
     * 
     * @paramp[in] shift на сколько разрядов сдвигать.
